...
## The output from this file is in "plot2.png"
## To run this code do 'source("plot2.R")' without the single quotes in R CLI.
...
## Create a PNG file
png(filename = "plot2.png", bg = "transparent", pointsize = 12, antialias = "cleartype") 
